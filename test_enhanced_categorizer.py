...
def test_enhanced_categorizer():
    ...
    """
    print("[TEST] Testing Enhanced Expense Categorizer")
    print("=" * 50)

    # Create and train the enhanced categorizer
    categorizer = EnhancedExpenseCategorizer()

    print("[TRAIN] Training the enhanced model...")
    ...
    if overall_accuracy >= 0.90:
        ...
        print(f"[WARNING] Enhanced categorizer achieved {overall_accuracy:.1%} accuracy (<90%)")
...
if __name__ == "__main__":
    ...
    if success:
        print(f"\n[COMPLETE] All tests passed! Enhanced categorizer is ready with >90% accuracy.")
        sys.exit(0)
    else:
